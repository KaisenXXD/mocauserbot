...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/KaisenXXD/Mocauserbot"
    )
    # External plugins repo
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "no") and not url(EXTERNAL_REPO):
        EXTERNAL_REPO = "https://github.com/KaisenXXD/MocaPlugins"
    ...
    BADMOCAP_REPO = os.environ.get("BADMOCA_REPO", "https://github.com/KaisenXXD/MocaPlugins")
    if BADMOCA_REPO and not url(BADMOCA_REPO):
        BADMOCA_REPO = "https://github.com/KaisenXXD/MocaPlugins"
    BADMOCA_REPOBRANCH = os.environ.get("BADCAT_REPOBRANCH", "badmoca")
